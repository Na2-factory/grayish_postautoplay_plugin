...
## v2.0.0からは、ユーザーの指定した記事数を倍に複製して動作します。
-②ノーマルタイプをご利用の場合、スライダー下部のプログレスバーについても、記事数の2倍の表示になります。

## 安定したスライド動作のため、記事数はできれば8以上に指定してください。

## 人気記事について
-ランキングの集計期間を指定した場合、サイトの状況によっては、記事数が少なくなり、スライド動作ができないケースがあります。
...
----------
Cocoon 2.8.5.1にアップデート後、
新着記事と人気記事ブロック・ショートコードについて
日付情報のアイコンが2つ表示されてしまいます。

プラグインv1.0.7にアップデートしていただくことで修正されます。
また、エディタ上では新着・人気記事の日付情報のONOFFができますが表示側には反映されませんのでご注意ください。
これまで通り常に表示します。

----------

# 新着記事ブロックなどの**追加CSSクラス**に指定のクラス名を入力することで、オートプレイのスライダーにすることが可能です。
